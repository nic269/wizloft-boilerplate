	...
	return (
		<main className="mx-auto max-w-6xl space-y-10 px-6 py-10">
			...
			<section className="grid gap-4 lg:grid-cols-3">
				{onboardingSteps.map((step) => (
					<Card key={step.title}>
						...
						<CardContent>
							<code className="block rounded-md border border-border bg-muted p-3 text-xs leading-5 text-muted-foreground">
								{step.command}
							</code>
						</CardContent>
					</Card>
			...
			<section className="space-y-4">
				<div>
					<h2 className="text-xl font-semibold tracking-normal">Template Tracks</h2>
