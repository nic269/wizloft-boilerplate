...
export const templateTracks = [
  {
    ...
    slug: "base",
    summary:
      "Reusable SaaS core with auth, organizations, RBAC, audit, API, providers, and tests.",
  ...
  },
  {
    ...
    keepOutOfCore: [
      "Provider-specific billing assumptions that not every future product needs.",
    ],
    name: "SaaS",
    path: "templates/saas",
    slug: "saas",
    summary:
      "Billing, pricing, entitlements, customer portal, subscription webhooks, and analytics.",
  ...
  },
  {
    ...
    keepOutOfCore: [
      ...
      "Grading rules.",
      "External classroom integration behavior.",
    ],
    name: "Education",
    path: "templates/education",
    slug: "education",
    summary:
      "Classes, lessons, assignments, attempts, media, CMS, and AI feedback extension points.",
  ...
  },
  {
    ...
    slug: "dev-tools",
    summary:
      "File conversion jobs, upload/download flow, job progress UI, and public API key model.",
    useWhen:
      "The product processes developer assets, files, or API-driven workflows.",
  },
  {
    additions: [
    ...
    slug: "shopify-addon",
    summary:
      "OAuth helpers, webhook verification, encrypted tokens, Admin API client, and sync jobs.",
    useWhen:
      "A future SaaS product needs Shopify integration without becoming a Shopify app.",
  },
  {
    additions: [
    ...
    keepOutOfCore: [
      "Shopify app framework assumptions.",
      "Embedded-app-only UI contracts.",
      "Store-domain logic.",
    ],
    ...
    summary:
      "Separate Shopify app surface that reuses shared packages without entering core.",
    useWhen: "The product should be distributed as a Shopify public app.",
  },
] as const satisfies readonly TemplateTrack[];

export const getTemplateTrack = (slug: string) =>
  templateTracks.find((template) => template.slug === slug);
